      ...
      <section className="py-24 md:py-32 px-6 md:px-16 max-w-1440 mx-auto w-full">
        ...
        <div className="flex overflow-x-auto gap-6 pb-8 snap-x hide-scrollbar -mx-6 px-6 md:mx-0 md:px-0">
          {CATEGORIES.map((cat, i) => (
            <motion.div
              key={i}
              className="min-w-[280px] md:min-w-[340px] aspect-[4/5] rounded-3xl overflow-hidden relative group cursor-pointer snap-start shrink-0 shadow-sm hover:shadow-xl transition-shadow duration-500"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={{
